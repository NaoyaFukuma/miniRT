...
/*   Updated: 2023/01/23 20:11:38 by kyamagis         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double	rt_calc_n_dot_l(t_rt_data *rt, t_3d_vec unit_n_vec, t_3d_vec unit_d_vec)
{
	double	n_dot_l;
									...
									t_lighting lighting)
{
	...
	res = result.insec_p;
	n_dot_l = rt_calc_n_dot_l(rt, res.unit_n_vec, lighting.unit_d_vec);
