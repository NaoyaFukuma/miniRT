...
/*   Updated: 2023/01/24 01:54:58 by nfukuma          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rt_fill_struct_c(t_rt_data *rt, const char **tokens)
{
	...
	{
		rt->scene.cam.unit_scr_dir_x_vec = rt_vec_to_unit(rt_vec_cross(rt_vec_constructor(0, 1, 0),
																		rt->scene.cam.unit_cam_dir));
		rt->scene.cam.unit_scr_dir_y_vec = rt_vec_to_unit(rt_vec_cross(rt->scene.cam.unit_cam_dir,
